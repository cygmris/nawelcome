(function ($) {
    $.fn.popcard = function (options) {
      ...
      if (options === "remove") {
        this.each(function() {
          $('#' + $(this).attr('data-popcard-id')).remove();
          $(this).off('mouseenter.popcard mouseleave.popcard');
        });
        return false;
      }
      ...
      return this.each(function() {
        var popcardId = Materialize.guid();
        var origin = $(this);
        origin.attr('data-tooltip-id', popcardId);
        ...
        var renderTooltipEl = function() {
          var popcard = $('<div class="material-popcard"></div>');

          // Create Text span
          if (allowHtml) {
            popcardText = $('<span></span>').html(tooltipText);
          } else{
            popcardText = $('<span></span>').text(tooltipText);
          }

          // Create tooltip
          popcard.append(tooltipText)
            .appendTo($('body'))
            .attr('id', tooltipId);
